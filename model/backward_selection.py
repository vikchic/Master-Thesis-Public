...
def run_backward_selection(years, candidate_features, spline_candidates, train_path):
    ...
    features, spline_features, prauc, history = hf.backward_feature_selection_ns(df_train, years, candidate_features, spline_candidates)
...
if __name__ == "__main__":
    ...
    features, spline_features, prauc, history = run_backward_selection(years, candidate_features, spline_candidates, train_path)
    print(history)